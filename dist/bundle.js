...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _services_getData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/getData */ \"./src/services/getData.ts\");\n/* harmony import */ var _components_card_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/card/card */ \"./src/components/card/card.ts\");\n/* harmony import */ var _components_card_character__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/card/character */ \"./src/components/card/character.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\nclass Dashboard extends HTMLElement {\n    constructor() {\n        super();\n        this.attachShadow({ mode: 'open' });\n    }\n    connectedCallback() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const episodeData = yield (0,_services_getData__WEBPACK_IMPORTED_MODULE_0__.EpisodeData)();\n            const characterData = yield (0,_services_getData__WEBPACK_IMPORTED_MODULE_0__.CharacterData)();\n            this.render(episodeData, characterData);\n        });\n    }\n    render(episodeData, characterData) {\n        if (this.shadowRoot) {\n            this.shadowRoot.innerHTML = '';\n            episodeData.forEach((e) => {\n                var _a;\n                const card = this.ownerDocument.createElement('app-card');\n                card.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_1__.episode_props.name, e.name);\n                card.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_1__.episode_props.air_date, e.air_date);\n                card.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_1__.episode_props.episode, e.episode);\n                card.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_1__.episode_props.character, e.character);\n                (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(card);\n            });\n            characterData.forEach((e) => {\n                var _a;\n                const character = this.ownerDocument.createElement('app-character');\n                character.setAttribute(_components_card_character__WEBPACK_IMPORTED_MODULE_2__.character_props.name, e.name);\n                character.setAttribute(_components_card_character__WEBPACK_IMPORTED_MODULE_2__.character_props.image, e.image);\n                (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(character);\n            });\n        }\n    }\n}\ncustomElements.define('app-dashboard', Dashboard);\n\n\n//# sourceURL=webpack://dca_template/./src/screens/dashboard.ts?");
