...
import { change_selection } from "../../store/actions";
...
export class Pixel extends HTMLElement {
    ...
    attributeChangedCallback (propName: pixel_props, oldValue: string, newValue: string) {
        switch (propName) {
    ...
    render() {
        ...
        link.setAttribute("href", "./css/pixel.css")
